...
const useStore = create((set) => ({
  ...
  planetRefs: {},
  setPlanetRef: (planet, ref) =>
    set((state) => ({ planetRefs: { ...state.planetRefs, [planet]: ref } })),
  ...
  setPresetIsTransitioning: (presetIsTransitioning) =>
    set({ presetIsTransitioning }),
  ...
  setAudioMixer: (planet, value) =>
    set((state) => ({ audioMixer: { ...state.audioMixer, [planet]: value } })),
  audioMixerSnapshot: null,
  setAudioMixerSnapshot: () =>
    set((state) => ({ audioMixerSnapshot: state.audioMixer })),
  muted: false,
  ...
  restoreSnapshot: () =>
    set((state) => ({ audioMixer: state.audioMixerSnapshot })),
}));
