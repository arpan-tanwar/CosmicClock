...
const GridRing = React.forwardRef(
  (
    ...
    useFrame((state) => {
      ...
      const worldCamProjPosition =
        gridRingMaterial.uniforms.worldCamProjPosition.value;
      const worldPlanePosition =
        gridRingMaterial.uniforms.worldPlanePosition.value;
